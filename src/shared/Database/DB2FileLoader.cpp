    ...
    for (uint32 x = 0; format[x]; ++x)
    {
        switch (format[x])
        {
            ...
            case FT_BYTE:
                ...
                break;
            case FT_LOGIC:
                assert(false && "DB2 files not have logic field type");
                break;
            case FT_NA:
            case FT_NA_BYTE:
                break;
