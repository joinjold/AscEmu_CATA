...
{
    if (
        sp->eff[0].EffectImplicitTargetA == ttype ||
        sp->eff[1].EffectImplicitTargetA == ttype ||
        sp->eff[2].EffectImplicitTargetA == ttype ||
        sp->eff[0].EffectImplicitTargetB == ttype ||
        sp->eff[1].EffectImplicitTargetB == ttype ||
        sp->eff[2].EffectImplicitTargetB == ttype
   )
        return true;
    return false;
}
