...
void GuildMgr::LoadGuilds()
{
    ...
    Log.Debug("GuildMgr", "Filling bank tabs with items...");
    {
        ...
        QueryResult* result = CharacterDatabase.Query("SELECT guildid, TabId, SlotId, item_guid FROM guild_bank_item");
    ...
    Log.Debug("GuildMgr", "Validating data of loaded guilds...");
    {
        uint32 oldMSTime = getMSTime();
        ...
        Log.Debug("GuildMgr", "Validated data of loaded guilds in %u ms", GetMSTimeDiffToNow(oldMSTime));
    }
}
...
void GuildMgr::LoadGuildRewards()
{
    ...
    do
    {
        ...
        if (!ItemPrototypeStorage.LookupEntry(reward.Entry))
        {
